              ...
              <div className="row">
                ...
                <div className="col-lg-8 detail-col-club">
                  ...
                  <p>
                    ...
                    sommun paroles, quande li coalingue simplic regulari quam
                    coalescent lingues.
                  </p>
                  <ul>
                  ...
                  <p>
                    Necessi uniform grammatica, pronunciation sommun paroles, quande
                    li coalingue simplic regulari coalescent lingues.
                  </p>
                </div>
              </div>
            </div>
